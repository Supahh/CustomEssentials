...
public class Lag implements Runnable {
    ...
    public static int getTick(int tick) {
        return TICK_COUNT;
    }
    ...
    public static BigDecimal getMaxRamDec() {
        return (new BigDecimal(Runtime.getRuntime().maxMemory())).setScale(2).divide(new BigDecimal(1048576), RoundingMode.HALF_EVEN);
    }
    ...
    public static BigDecimal getUsedRAMDec() {
        return (new BigDecimal(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())).setScale(2).divide(new BigDecimal(1048576), RoundingMode.HALF_EVEN);
    }
